...
export const metadata = {
  title: "Chikindin-design: О нас",
  description: "Страница для знакомства с Региной и Олегом Чикиндиными - основателями студии Chikindin-design.",
};
    ...
    <section className="p-4 md:p-[2rem] lg:p-[8rem] text-xl">
      ...
      <div className="flex flex-col items-left gap-4 mb-8">
        <div className="w-fit lg:w-[60%]">
          <Image src={chikindinsImage} alt="Олег" placeholder="blur" width="auto" />
        </div>
      </div>
      <p className="mb-[5.625rem] font-bold lg:w-4/5">
        Работая с нами вы получите не только превосходный результат, но и приятный опыт общения и
